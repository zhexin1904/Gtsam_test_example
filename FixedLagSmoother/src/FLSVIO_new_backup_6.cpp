...
int main(int argc, char* argv[]) {
    gtsam::Rot3 R_b_cam0(-0.00687471,  0.00363623,  0.99996976,
                        0.99996189,  0.00540677,  0.00685499,
                        -0.00538168,  0.99997877, -0.00367326);

    gtsam::Point3 t_b_cam0(0.06468167, 0.0045967, 0.01772615);
    gtsam::Pose3 T_b_cam0(R_b_cam0, t_b_cam0);
    // gtsam::Pose3 T_b_cam0(gtsam::I_4x4);

    gtsam::Rot3 R_cam1_cam0(0.99957357, -0.02523796,  0.0146873,
                            0.02532334,  0.99966331, -0.00565602,
                            -0.01453961,  0.00602554,  0.99987614);

    gtsam::Point3 t_cam1_cam0(-0.34225768, -0.01055272, -0.00978101);
    gtsam::Pose3 T_cam1_cam0(R_cam1_cam0, t_cam1_cam0);


    gtsam::Rot3 R_cam2_cam1(0.99960544,  0.02768245, -0.00475978,
                            -0.02755993,  0.99932907,  0.02412164, 
                            0.00542434, -0.02398094,  0.9996977);

    gtsam::Point3 t_cam2_cam1(0.68542113, 0.00261338, -0.00365451);
    ...
    std::string in_frontend("/home/jason/DPGO/FixedLagSmoother/kri2_Lmk.txt");
    std::string in_initials("/home/jason/DPGO/FixedLagSmoother/kri2_initials.txt");
...
//
    ...
    SmartProjectionParams params(gtsam::HESSIAN, gtsam::ZERO_ON_DEGENERACY);
    auto gaussian = gtsam::noiseModel::Isotropic::Sigma(2, 15.0);


    // cam0 : 268.0886807833101, 266.2531972184412, 339.57968813983365, 175.06123592987922
    double fx0 = 1776.725301999032;
    double fy0 = 1776.8845068904102;
    double cx0 = 618.247118871851;
    double cy0 = 471.1453896366428;
    // cam1 : 1827.6738715157737, 1827.6048759054268, 622.9891361245537, 492.407424212944
    double fx1 = 1770.5262320986242;
    double fy1 = 1771.3796638446206;
    double cx1 = 614.2918796451348;
    double cy1 = 471.9677947385792;
    // cam2 : 1838.7616369388181, 1839.260979008592, 632.0425851788087, 487.113852267931
    double fx2 = 1772.901631920921;
    double fy2 = 1774.361345183585;
    double cx2 = 591.956291688635;
    double cy2 = 462.6017138429535;
